...
// TODO: Esto puede pasar a ser data
const skuSizeCode = {
  s: 'sm',
  m: 'md',
  l: 'lg',
...
const VariantForm = ({
  ...
  // TODO: Reemplazar ref con esto

  const [colorInput, setColorinput] = useState('');

  const colorInputRef = useRef();
  const colorAltInputRef = useRef();
              ...
              <tbody>
                {sizes.map((size, sizeIndex) => (
                  <tr key={size}>
                    ...
                    <td>
                      {sizeIndex === 0 && (
                        <input type="checkbox" ref={colorAltInputRef} />
                      )}
                    </td>
                    <td>
                      {sizeIndex === 0 && (
